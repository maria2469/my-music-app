...
import { TbRobot } from 'react-icons/tb'; // Importing chatbot icon
...
const Chatbot: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#640D14] text-white p-3 shadow-lg flex items-center space-x-4">
        <button
